...
To update the database use this command from the Web project folder (replace `Damon.ClenArch` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../Damon.ClenArch.Infrastructure/Damon.ClenArch.Infrastructure.csproj -s Damon.ClenArch.Web.csproj
```
