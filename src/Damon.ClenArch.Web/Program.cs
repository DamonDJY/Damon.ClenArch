...
using Damon.ClenArch.Infrastructure;
using Damon.ClenArch.Infrastructure.Data;
using Damon.ClenArch.Infrastructure.Email;
using Damon.ClenArch.UseCases.Contributors.Create;
using FastEndpoints;
...
System.Console.WriteLine("app env: " + app.Environment.EnvironmentName+ "  this is Dev:" + app.Environment.IsDevelopment());
